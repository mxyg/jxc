...
<script type="text/javascript">    window.onbeforeunload = function(){    return "数据无价，请及时备份您的重要数据。\n备份方法：设置-->备份与恢复\n备份的数据下载到本地更安全哦";    } </script>
  ...
  <div id="col-main">
    <div id="main-hd" class="cf">
      ...
      <ul class="user-menu">
      	...
      	<li class="space">|</li>-->
      	<!--<li class="qq"><a href="" onClick="return false;" id="wpa">产品咨询</a></li>
      	<li class="space">|</li> -->
        
     <!-- 	<li class="telphone">电话：18170521585</li> -->
       <!-- <li class="space">|</li> -->
      	<li ><a class="service-tab" data-tab="3" >产品购买</a></li>
        <li class="space">|</li>
      	<li id="sysSkin">风格</li>
        <li class="space">|</li>
        
      	<li><a href="http://www.ew80.com" target="_blank" >官网</a></li>
		<li class="space">|</li>
        <!-- 
...
<div id="selectSkin" class="shadow dn">
	<ul class="cf">
        ...
        <li><a id="skin-green"><span></span><small>魅蓝</small></a></li>
    </ul>
</div>
