      ...
      <dd class="con">
        <div class="service-box contact">
   		  <div class="service-hd contact-txt">
    			<p>感谢您使用：易网翼云进销存多仓库版, </p>
				<p>产品购买或技术服务请直接点击以下QQ咨询 </p>
				
				<p><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=270012912&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:270012912:42" alt="点击这里给我发消息" title="点击这里给我发消息"></a></p>
				<p><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=289669073&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:289669073:42" alt="点击这里给我发消息" title="点击这里给我发消息"></a></p>
				<p> 您更可以通过拨打我们的服务电话：18170521585（支持微信和短信）</p>
				<p> 官方网站：http://www.ew80.com</p>
		  </div>
   		</div>
