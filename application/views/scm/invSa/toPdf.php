...
<?php for($t=1; $t<=$countpage; $t++){?>
			   ...
			   ?>
				<tr style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;font-family:'宋体'; font-size:12px;">
				   <td width="30"  align="center"><?php echo $row['i']?></td>
					...
					<td width="60" style="border:solid #000000;border-width:0 1px 1px 0;height:15px;font-family:'宋体'; font-size:12px;"><?php echo $row['invSpec']?></td>
		...
		<table  width="800" align="center">
		  <tr height="15" align="left">
		    <td align="left" style="font-family:'宋体'; font-size:12px;height:25px;">备注： <?php echo $description?></td>
	      </tr>
</table>	
